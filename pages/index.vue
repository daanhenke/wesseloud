<template>
  <div class="page" ref="sectionContainer">
    <section-hero />
    <div class="work">
      <section-slanted :rotation="getRotation(i)" :data-index="i" v-for="i in [0, 1, 2, 3]" :key="i">
        hello {{ i }}
      </section-slanted>
    </div>
  </div>
...
<style scoped>
  ...
  .section-slanted[data-index="3"] { --z: 0; }
</style>
...
export default {
  ...
  methods: {
    getRotation(i) { return (i % 2 === 0) ? max_rotation : -max_rotation }
  }
}
</script>
